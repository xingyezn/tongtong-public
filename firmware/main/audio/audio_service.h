...
#define TTS_PLAYBACK_PREBUFFER_DEFAULT_MS 1200
#define TTS_PLAYBACK_PREBUFFER_MIN_MS 240
#define TTS_PLAYBACK_PREBUFFER_MAX_MS 1500
#define TTS_PLAYBACK_PREBUFFER_DEFAULT_FRAMES (TTS_PLAYBACK_PREBUFFER_DEFAULT_MS / OPUS_FRAME_DURATION_MS)
#define TTS_PLAYBACK_PREBUFFER_MAX_FRAMES ((TTS_PLAYBACK_PREBUFFER_MAX_MS + OPUS_FRAME_DURATION_MS - 1) / OPUS_FRAME_DURATION_MS)
#define MAX_PLAYBACK_TASKS_IN_QUEUE (TTS_PLAYBACK_PREBUFFER_MAX_FRAMES + 2)
...
public:
    ...
    // Set the TTS startup buffer for subsequent playback streams.
    void SetPlaybackPrebufferMs(int buffer_ms);
...
private:
    ...
    size_t configured_prebuffer_frames_ = TTS_PLAYBACK_PREBUFFER_DEFAULT_FRAMES;
